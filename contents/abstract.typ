#let abstract_zh = [
  *摘要*：本文设计了一个基于Typst模板的浙江工商大学毕业设计模板，以帮助学生更加方便地完成毕业设计的撰写和排版。该模板采用了现代化的排版设计和易于使用的用户界面，可以帮助学生快速地完成毕业设计的撰写和排版工作。

  在设计过程中，我们结合了Typst模板的优秀设计和浙江工商大学毕业设计的要求，对模板进行了优化和适配。该模板包含了毕业设计所需的各种元素，包括封面、摘要、目录、正文、参考文献等。同时，我们还为学生提供了详细的使用说明和技术支持，以帮助他们更加顺利地完成毕业设计的撰写和排版。

  本文的研究对于提高浙江工商大学毕业设计的质量和效率具有重要意义。通过设计一个优秀的毕业设计模板，可以使学生更加专注于毕业设计的内容和研究，从而提高毕业设计的质量和水平。同时，该模板还可以帮助学生更加便捷地完成毕业设计的排版和输出工作，提高毕业设计的效率和准确性。
]

#let keywords_zh = ("Typst模板", "浙江工商大学", "本科毕业设计")


#let abstract_en = [
  *Abstract*：In this paper, we design a graduation thesis template based on Typst to help students complete their graduation thesis writing and typesetting more conveniently at Zhejiang Gongshang University. The template adopts modern typesetting design and user-friendly interface, which can help students complete graduation thesis writing and typesetting work quickly.
...
#let keywords_en = ("Typst Template", "Zhejiang Gongshang University", "Undergraduate Thesis")