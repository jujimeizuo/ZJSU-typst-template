#let abstract_zh = [
  本文设计了一个基于Typst模板的浙江工商大学毕业设计模板，以帮助学生更加方便地完成毕业设计的撰写和排版。该模板采用了现代化的排版设计和易于使用的用户界面，可以帮助学生快速地完成毕业设计的撰写和排版工作。
...
#let abstract_en = [
  In this paper, we design a graduation thesis template based on Typst to help students complete their graduation thesis writing and typesetting more conveniently at Zhejiang Gongshang University. The template adopts modern typesetting design and user-friendly interface, which can help students complete graduation thesis writing and typesetting work quickly.
